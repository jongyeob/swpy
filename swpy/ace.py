...
if __name__ == '__main__':
    ...
    start = dt.parse(startdate)
    end = dt.parse(enddate)
    
    filepath = path_local(dt.tuples(start,'date'), 'mag')
    mag_filepath = download(start, 'mag',DATA_DIR+filepath)
    mag_data = load_mag(mag_filepath)
    ...
    filepath = path_local(dt.tuples(start,'date'), 'swepam')
